...
from ..define.events.machinery.machinery_workstation import (
    MachineryWorkstationDoCraft,
)
from ..define.id_enum.machinery import MACHINERY_WORKSTATION as MACHINE_ID
from ..machinery_def.machinery_workstation import (
    recipes as Recipes,
    get_pincer_level,
    get_wrench_level,
)
from ..ui_sync.machinery.machinery_workstation import MachineryWorkstationUISync
...
class MachineryWorkstation(BaseMachine, GUIControl, ItemContainer):
    ...
    def craft_times(self):
        # type: () -> int
        return self.bdata[K_CRAFT_TIMES]
