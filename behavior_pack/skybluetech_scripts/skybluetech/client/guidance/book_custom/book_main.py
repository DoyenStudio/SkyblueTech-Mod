...
main_pages = PageGroup([
    TextPage(
        "main",
        "蔚蓝科技",
        '蔚蓝空域精英计划¹；\n红石能专业必修教材²；\n红石能电路基础³\n\n本书将带您走进复杂、 高度自由、 充满希望的蔚蓝科技®红石能<item id="skybluetech:redstoneflux_core">世界， 教导您从如何使用<style color="§c">红石能<style color="R">到设计出复杂的成品生产线。',
    ...
    MainTOCPage(
        ...
        [
            ...
            MainTOCPageSection(
                id_enum.MACHINERY_FRAME, 0, "机器设备", contents.machinery.machinery_toc
            ),
        ],
    ),
])
