...
from skybluetech_scripts.skybluetech.common.machinery_def.mixed_macerator import (
    STORE_RF_MAX,
    recipes,
)
...
@RegistToolDeltaScreen("MixedMaceratorUI.main", is_proxy=True)
class MixedMaceratorUI(MachinePanelUIProxyEx):
