...
creative_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.CREATIVE_GENERATOR),
...
gas_burning_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.GAS_BURNING_GENERATOR),
...
geothermal_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.GEO_THERMAL_GENERATOR),
...
reacting_thermal_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.REACTING_THERMAL_GENERATOR),
...
redstone_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.REDSTONE_GENERATOR),
...
solar_panel = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.SOLAR_PANEL),
...
thermal_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.THERMAL_GENERATOR),
...
wind_generator = PageGroup(
    ...
    [
        TextPage(
            UnfinishedItemName(id_enum.Machinery.WIND_GENERATOR),
